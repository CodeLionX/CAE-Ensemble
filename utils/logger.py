...
def create_logger(
    dataset, train_logger_name, file_logger_name, meta_logger_name, model_name, pid
):
    ...
    if dataset == -1:
        ...
        file_logger = setup_logger(
            file_logger_name + model_name + str(pid),
            "./logs/{}/file_autotsad_{}_{}.log".format(dataset, model_name, pid),
        )
        # second file logger
        meta_logger = setup_logger(
            meta_logger_name + model_name + str(pid),
            "./logs/{}/meta_autotsad_{}_{}.log".format(dataset, model_name, pid),
        )
        # third file logger
        train_logger = setup_logger(
            train_logger_name + model_name + str(pid),
            "./logs/{}/train_autotsad_{}_{}.log".format(dataset, model_name, pid),
        )
    elif dataset == 0:
        # first file logger
        file_logger = setup_logger(
